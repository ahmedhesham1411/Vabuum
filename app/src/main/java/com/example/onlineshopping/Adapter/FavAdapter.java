...
public class FavAdapter extends RecyclerView.Adapter<FavAdapter.MyViewHolder> {
    ...
    public FavAdapter(List<ItemFav> items, Context context, OnClickHander onClickHander) {
        this.items = items;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_fav, null);
