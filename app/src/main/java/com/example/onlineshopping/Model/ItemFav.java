...
public class ItemFav {
    ...
    String cat;
    String item_id_cart;
    public ItemFav(String userid, String imageURL, String item_desc, String item_id, String item_name, String item_price, String count, String cat, String item_id_cart) {
        this.userid = userid;
